...
export const extractionCases: Case[] = [
  ...
  { name: "dollar loss total is not a claim count", notes: "Loss history: $120,000 in paid losses over the past five years. Built in 2001.", expected: facts({ yearBuilt: 2001, losses: null }), note: "A dollar total says nothing about how many claims occurred in three years, and without a stated window it is not the five-year loss value line either." },
