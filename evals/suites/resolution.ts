...
const cases: { name: string; label?: string; candidates: FieldCandidate[]; expect: Partial<Resolved> & { conflictMentions?: string[]; noConflict?: boolean; confidenceAtLeast?: number; confidenceBelow?: number }; note?: string }[] = [
