...
export function ReviewResult({ result, rank, label }: { result: RankedSubmission; rank?: number; label?: string }) {
  ...
  return <section className="review-result" aria-label="Appetite recommendation">
