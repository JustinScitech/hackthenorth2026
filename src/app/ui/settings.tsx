    ...
    <main className="shell shell-narrow">
      ...
      <div className="settings-stack">
        ...
        <section className="card" aria-labelledby="workspace-title">
          ...
          <div className="setting-row"><div><strong>Guideline rules</strong><p>The case review flow uses fictional demo rules. Federato triage uses the supplied 2025 appetite.</p></div><span className="value">demo</span></div>
